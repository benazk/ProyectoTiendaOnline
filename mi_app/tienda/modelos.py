...
class Product(db.Model, miCRUD):  
    ...
    imagenBig = db.Column(db.String(255))
...
#Relación con la tabla Historial y tabla Detalles (N:M)
    ...
    def __init__(self, nombre, precio, descripcion, disponibilidad, desarrolladora, imagen, imagenBig, palabrasClave, destacados, category):
        self.nombre = nombre
        self.precio = precio 
