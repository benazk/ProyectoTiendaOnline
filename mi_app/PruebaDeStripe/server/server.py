...
@app.route("/create-payment-intent", methods=["POST"]) #Esta funcion crea un intent de pago, osea que esto es lo que le pasa los datos del carrito a stripe
